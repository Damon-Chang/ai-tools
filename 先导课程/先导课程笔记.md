...
|学习名称|类别|内容简介|学习路径|适合岗位|
| ---- | ---- | ---- | ---- | ---- |
|校园到职场的角色转变|网站|校园到职场的角色转变|详见中兴e学院（euniv.zte.com.cn）-力鼎萌新-职业素质类知识|所有|
|全方位入门git|网站|代码版本控制的利器，广泛应用于开发实践，代码管理|导师微信推送网站链接 https://www.imooc.com/learn/1278|AI算法工程师|
|Build a Large Language Model (From Scratch)|网站|这本书中强调动手实践，主要使用了PyTorch，不依赖现有库，通过一些图标帮助读者理解LLM的工作原理，涉及到预训练和微调的常用工作流程。|导师微信推送网站链接 https://github.com/rasbt/LLMs-from-scratch/tree/main|AI算法工程师|
|《高效能人士的七个习惯》|书籍|长期成长，高效行为模式|作者:[美] 史蒂芬·柯维；出版社:中国青年出版社，书籍自备|大数据开发|
|大模型基础|书籍|针对大语言模型系统地讲解相关基础知识和前沿技术|导师微信推送网站链接 https://github.com/ZJU-LLMs/Foundations-of-LLMs|大数据开发|
|《由浅入深 PostgreSQL》|书籍|全面了解PostgreSQL数据库，熟悉其基本概念、架构和工作原理。从基础语法到高级特性，系统掌握PostgreSQL数据库的使用方法。|作者:彭煜玮 出版社:清华大学出版社，书籍自备|数据库工程师|
|《UNIX环境高级编程》|书籍|掌握UNIX操作系统的核心概念、进程管理、内存管理、文件系统等底层机制，清晰认识操作系统如何协调各种资源，为上层应用提供稳定运行环境。|出版社:人民邮电出版社，书籍自备|数据库工程师|
|李宏毅机器学习2025|网站|本次课程聚焦于从经典AI算法原理出发，让大家逐步感受AI的美丽，理解ai背后的秘密。|在“Bilibili网站”搜索学习名称内容即可学习|算法工程师|
|李宏毅2024春《生成式人工智能导论》|网站|课程聚焦于生成式人工智能技术的基础知识，让大家提前了解生成式AI的相关知识。|在“Bilibili网站”搜索学习名称内容即可学习|算法工程师|
|金字塔原理|书籍|金字塔原理是一项层次性、结构化的思考、沟通技术，可以用于结构化的说话与写作过程。|作者:芭芭拉.明托 出版社:南海出版公司，书籍自备|技术研究工程师|
|RAG关键技术|网站|检索增强生成（RAG）各阶段的关键技术以及高级RAG应用范例。|导师微信推送网站链接 https://github.com/NirDiamant/RAG_Techniques?tab=readme-ov-file|技术研究工程师|
|知识图谱导论|网站|课程全面覆盖了知识图谱的表示、存储、获取、推理、融合、问答和分析等七大方面，同时囊括多模态知识图谱、知识图谱与图神经网络的融合、本体表示学习、事理知识图谱，以及知识增强的语言预训练模型等新热点、新发展。|导师微信推送网站链接 https://person.zju.edu.cn/huajun|技术研究工程师| 
